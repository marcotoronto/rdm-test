...
- Files can be `Restricted` or `Embargoed` so they are available only on request. You can learn more about data access restrictions in the Advanced Deposit workshop. 
